    ...
    <div className="rounded-[26px] border bg-card p-5 shadow-lift">
      ...
      <div className="mt-3 space-y-2">
        ...
        <div className="flex items-center justify-between rounded-xl border px-4 py-3">
          <div className="flex items-center gap-2.5">
            <span className="flex h-6 w-6 items-center justify-center rounded-md bg-secondary text-xs">🏦</span>
      ...
      <button className="mt-4 w-full rounded-xl bg-deep py-3.5 text-sm font-semibold text-white transition-opacity hover:opacity-90">
        Payer 500,00 $
      </button>
    </div>
